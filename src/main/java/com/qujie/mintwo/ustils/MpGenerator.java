...
//        gc.setOutputDir("D://workspace/spring-boot-mybatis/src/main/java");
        gc.setOutputDir("D://poject/minTwoPoject/src/main/java");
        ...
        dsc.setUrl("jdbc:sqlserver://localhost:1433;databaseName=BackstageManageDB");
...
//        strategy.setTablePrefix(new String[] { "studentInformation" });// 此处可以修改为您的表前缀
        ...
        strategy.setInclude(new String[] { "tbUser" }); // 需要生成的表
        ...
        pc.setParent("com.qujie.mintwo.system.user");
